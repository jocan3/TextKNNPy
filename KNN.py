...
while (datasetRepresentationDescription is not None):
    ...
    for (metricName) in metricNames:
        ...
        if (metricName == "Jaccard" and "without TF-IDF" in datasetRepresentationDescription) or metricName == "Cosine":
            #print("3")
                ...
                for (trainValue) in trainList:
                    ...
                    for (additionalInfo) in techniques:
                        ...
                        if (additionalInfo == "bagging"):
                           # print("8")
                            bagging = BaggingClassifier(neigh,max_samples=0.5, max_features=1.0)
